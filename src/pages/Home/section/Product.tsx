export const Product = () => {
  return (
    <div className="mt-[164px] container">
      ...
      <div className=" mt-[30px] flex justify-between items-center gap-[30px] relative">
        <button className=" rounded-full p-[10px] bg-black-panel hover:bg-black-button transition focus:ring focus:ring-slate-500 flex items-center justify-center absolute left-0 -translate-x-1/2 top-1/2 -translate-y-1/2 z-10">
          <i className="bx bx-chevron-left bx-md text-text-primary"></i>
        </button>
        <button className=" rounded-full p-[10px] bg-black-panel hover:bg-black-button transition focus:ring focus:ring-slate-500 flex items-center justify-center absolute right-0 top-1/2 translate-x-1/2 -translate-y-1/2 z-10">
